...
int main()
{
	...
	Scene scene;
	scene.addBalle(40, sf::Color::Black, 1, 100, 0, 0);  //-80/sqrt(2)
	scene.addBalle(40, sf::Color::Red, 1, 400, 0, 1);  //-80/sqrt(2)
	
	//scene.addBalle(40, sf::Color::Red, 1, LARGEUR_FENETRE/2-80/sqrt(2), 0, 0);  //-80/sqrt(2)
